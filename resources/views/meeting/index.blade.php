    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Meeting')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('meeting.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-ajax-popup="true" data-title="{{ __('Create New Meeting') }}">
                                            ...
                                            <td class="text-right action-btns">
                                                @can('Edit Meeting')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Meeting') }}" class="edit-icon"
                                                ...
                                                @can('Delete Meeting')
                                                    ...
                                                    <form action="{{ route('meeting.destroy', ['meeting' => $meeting->id]) }}"
                                                        method="POST" id="delete-form-{{ $meeting->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                @endcan
