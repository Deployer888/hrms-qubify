    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Termination Type')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('terminationtype.create') }}"
                                        ...
                                        <td>
                                            @can('Edit Termination Type')
                                                <a href="#"
                                                    ...
                                                    data-title="{{ __('Edit Termination Type') }}" class="edit-icon"
                                            ...
                                            @can('Delete Termination Type')
                                                <a href="#" class="delete-icon" data-bs-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $terminationtype->id }}').submit();"><i
