                                                            ...
                                                            <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                                <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                    <p style="margin: 10px 0;">
                                                                        {{ 'I have ' . strtolower($leave->status) . 'd your ' . ($leave->leaveType ? $leave->leaveType->title : 'Leave') . ' request for ' . $leave->leave_reason }}
                                                                        @if($leave->isShortLeave() && $leave->start_time && $leave->end_time)
                                                                            {{ ' on ' . \Auth::user()->dateFormat($leave->start_date) . ' from ' . $leave->formatted_start_time . ' to ' . $leave->formatted_end_time }}
                                                                        @elseif($leave->isHalfDay())
                                                                            {{ ' on ' . \Auth::user()->dateFormat($leave->start_date) . ($leave->day_segment ? ' (' . ucwords($leave->day_segment) . ')' : '') }}
                                                                        @else
                                                                            @if($leave->start_date === $leave->end_date)
                                                                                {{ ' on ' . \Auth::user()->dateFormat($leave->start_date) }}
                                                                            @else
                                                                                {{ ' from ' . \Auth::user()->dateFormat($leave->start_date) . ' to ' . \Auth::user()->dateFormat($leave->end_date) }}
                                                                            @endif
                                                                        @endif
                                                                        {{ '.' }}
                                                                    </p>
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                                <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                    <p style="margin: 10px 0;">
                                                                        {{ 'I have ' . strtolower($leave->status) . 'ed your ' . ($leave->leaveType ? $leave->leaveType->title : 'Leave') . ' request for ' . $leave->leave_reason }}
                                                                        @if($leave->isShortLeave() && $leave->start_time && $leave->end_time)
                                                                            {{ ' on ' . \Auth::user()->dateFormat($leave->start_date) . ' from ' . $leave->formatted_start_time . ' to ' . $leave->formatted_end_time }}
                                                                        @elseif($leave->isHalfDay())
                                                                            {{ ' on ' . \Auth::user()->dateFormat($leave->start_date) . ($leave->day_segment ? ' (' . ucwords($leave->day_segment) . ')' : '') }}
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                                <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                    ...
                                                                    <p style="margin: 10px 0; padding: 10px; background-color: #f8f9fa; border-left: 4px solid #dc3545; font-style: italic;">
                                                                        @if(!empty($leave->reject_reason))
                                                                            {{ $leave->reject_reason }}
                                                                        @else
                                                                            {{ __('No specific reason was provided.') }}
                                                                        @endif
                                                                    </p>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;">
                                                                    <i style="font-style:normal">
                                                                        <b style="font-weight:700">{{ __("Regards,") }}</b>
                                                                    </i>
                                                                </p>
                                                                <p style="margin: 10px 0;">
                                                                    <i style="font-style:normal">
                                                                        <b style="font-weight:700">{{ __($approved_by['by'].',') }}</b>
                                                                    </i>
                                                                </p>
                                                                <p style="margin: 10px 0;">
                                                                    <i style="font-style:normal">
                                                                        <b style="font-weight:700">{{ __($approved_by['name'].',') }}</b>
                                                                    </i>
                                                                </p>
