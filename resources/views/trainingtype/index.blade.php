    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Training Type')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('trainingtype.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('Edit Training Type')
                                                <a href="#" data-url="{{ route('trainingtype.edit', $trainingtype->id) }}"
                                                    data-size="lg" data-ajax-popup="true"
                                                    data-title="{{ __('Edit Training Type') }}" class="edit-icon"><i
                                                        class="fas fa-pencil-alt"></i></a>
                                            @endcan
                                            @can('Delete Training Type')
                                                <a href="#" class="delete-icon"
                                                    data-confirm="{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}"
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $trainingtype->id }}').submit();"><i
