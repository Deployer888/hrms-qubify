        ...
        <div class="col-md-6">
            <div class="card card-fluid">
                ...
                <div class="card-body employee-detail-edit-body">
                    ...
                    <!-- Address input -->
                    {{-- @if (\Auth::user()->type == 'employee' || ($allRoles && $allRoles->pluck('name')->contains('employee'))) --}}
                        <input type="submit" value="Update" class="btn-create btn-xs badge-blue radius-10px float-right" style="position: absolute; right: 12px; bottom: 12px;">
                    {{-- @endif --}}
                </div>
            </div>
        </div>
