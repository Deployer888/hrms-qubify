                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between w-100">
                                    ...
                                    <a href="#" data-url="{{ route('permissions.create') }}"
                                        class="btn btn-sm btn-primary btn-round btn-icon" data-ajax-popup="true"
                                        data-toggle="tooltip" data-title="{{ __('Add Permission') }}"
                                        data-original-title="{{ __('Add Permission') }}">
                                            ...
                                            <div class="col-sm-12 card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-striped dataTable">
                                                        <thead class="">
                                                            <tr>
                                                                <th scope="col">{{ __('title') }}
                                                                </th>
                                                                <th scope="col">{{ __('module') }}
                                                                </th>
