    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Warning')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('warning.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-ajax-popup="true" data-title="{{ __('Create New Warning') }}">
                                            ...
                                            <td class="text-right action-btns">
                                                @can('Edit Warning')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Warning') }}" class="edit-icon"
                                                ...
                                                @can('Delete Warning')
                                                    <a href="#" class="delete-icon" data-bs-toggle="tooltip"
                                                        ...
                                                        data-confirm-yes="document.getElementById('delete-form-{{ $warning->id }}').submit();"><i
