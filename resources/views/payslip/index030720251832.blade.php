...
@section('action-button')
    @can('Create Pay Slip')
        <form action="{{ route('payslip.store') }}" method="POST" class="w-50 float-left" id="payslip_form">
            @csrf
            <div class="row d-flex justify-content-end">
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="all-select-box">
                        <div class="btn-box">
                            <label for="month" class="text-type">{{ __('Select Month') }}</label>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="all-select-box">
                        <div class="btn-box">
                            <label for="year" class="text-type">{{ __('Select Year') }}</label>
                    ...
                    <form>
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <div class="float-right col-4">
                                <select class="form-control month_date select2" name="year" tabindex="-1"
                                    aria-hidden="true">
                                    <option value="--">--</option>
                            ...
                            @can('Create Pay Slip')
                                <input type="button" value="{{ __('Bulk Payment') }}"
                                    class="btn-create badge-blue float-right search mt-0" id="bulk_payment">
                            @endcan
                        </div>
                    </form>
                </div>
            ...
            var table = $('#dataTable1').DataTable({
                "aoColumnDefs": [{
                        ...
                        "mRender": function(data, type, full) {
                            ...
                            if (data[5] == 'Paid')
                                return '<div class="badge badge-pill badge-success"><a href="#" class="text-white">' +
                                    data[5] + '</a></div>';
                            else
                                return '<div class="badge badge-pill badge-danger"><a href="#" class="text-white">' +
                                    data[5] + '</a></div>';
                        }
                    },
                    {
                        ...
                        "mRender": function(data, type, full) {
                            ...
                            if (data[6] != 0) {
                                var payslip = '<a href="#" data-url="{{ url('payslip/pdf/') }}/' +
                                    id + '/' + datePicker +
            ...
            function callback() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (!(data)) {
                            show_toastr('error', 'Employee payslip not found ! please generate first.',
                                'error');
                        }
                    },
                    error: function(data) {
