<style>
    /* Enhanced Role Edit Form Styles */
    :root {
    ...
    /* Disabled form control for employee role */
    .premium-form-control[style*="not-allowed"] {
    ...
    .form-body::-webkit-scrollbar-thumb:hover {
        background: linear-gradient(135deg, #667eea 0%, #b45309 100%);
    }
    ...
    <div class="premium-form-container">
        ...
        <form action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="role-info-card">
                    <div class="premium-form-group">
                        ...
                        @if ($role->name == 'employee')
                            <div class="premium-form-control" style="background: var(--light); cursor: not-allowed;">
                                {{ ucfirst($role->name) }}
                            </div>
                        @else
                            <input type="text"
                                        ...
                                        if (in_array($permName, (array) $permissions)) {
                                            ...
                                            if ($key !== false) {
                                                $modulePermissions[] = [
                                                    ...
                                                    'name' => $permName,
                                                    'type' => $type,
                                                    'checked' => $role->permissions->contains('id', $key)
                                                ];
                                            }
                                        }
                                    }
                                    ...
                                    <div class="module-card">
                                        ...
                                        <div class="permissions-list">
                                            @foreach ($modulePermissions as $permission)
                                                <div class="permission-item permission-{{ strtolower($permission['type']) }} {{ $permission['checked'] ? 'checked' : '' }}">
                                                    <label class="premium-checkbox">
                                                        <input type="checkbox"
            ...
            <div class="form-actions">
                <button type="button" class="premium-btn btn-cancel" data-bs-dismiss="modal">
                    <i class="fas fa-times"></i>
                    {{ __('Cancel') }}
                </button>
                <button type="submit" class="premium-btn btn-update">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Update module select all checkboxes based on individual permissions
            function updateModuleSelectAll() {
                $('.ischeck').each(function() {
                    var moduleId = $(this).data('id');
                    var totalCheckboxes = $('.isscheck_' + moduleId).length;
                    var checkedCheckboxes = $('.isscheck_' + moduleId + ':checked').length;
            ...
            // Initialize styles and module select all
            updatePermissionItemStyles();
            updateModuleSelectAll();
