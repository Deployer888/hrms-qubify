    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Transfer')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('transfer.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-ajax-popup="true" data-title="{{ __('Create New Transfer') }}">
                                            ...
                                            <td class="text-right action-btns">
                                                @can('Edit Transfer')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Transfer') }}" class="edit-icon"
                                                ...
                                                @can('Delete Transfer')
                                                    ...
                                                    <form method="DELETE" action="{{ route('transfer.destroy', $transfer->id) }}" id="delete-form-{{ $transfer->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                    </form>
