    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Allowance Option')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('allowanceoption.create') }}"
                                        ...
                                        <td>
                                            @can('Edit Allowance Option')
                                                <a href="#"
                                                    ...
                                                    data-title="{{ __('Edit Allowance Option') }}" class="edit-icon"
                                            ...
                                            @can('Delete Allowance Option')
                                                <a href="#" class="delete-icon" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $allowanceoption->id }}').submit();"><i
