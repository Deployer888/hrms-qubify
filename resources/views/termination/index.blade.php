    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Termination')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('termination.create') }}"
                            ...
                            <tbody class="font-style">
                                @foreach ($terminations as $termination)
                                    <tr>
                                        ...
                                        <td style="text-wrap: auto;">{{ $termination->description }}</td>
                                        @if (Gate::check('Edit Termination') || Gate::check('Delete Termination'))
                                            <td class="text-right action-btns">
                                                @can('Edit Termination')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Termination') }}" class="edit-icon"
                                                ...
                                                @can('Delete Termination')
                                                    <a href="#" class="delete-icon" data-bs-toggle="tooltip"
                                                        ...
                                                        data-confirm-yes="document.getElementById('delete-form-{{ $termination->id }}').submit();"><i
