    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Job Category')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('job-category.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('Edit Job Category')
                                                <a href="#" data-url="{{ route('job-category.edit', $category->id) }}"
                                                    data-size="lg" data-ajax-popup="true"
                                                    data-title="{{ __('Edit Job Category') }}" class="edit-icon"
                                            ...
                                            @can('Delete Job Category')
                                                <a href="#" class="delete-icon" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $category->id }}').submit();"><i
