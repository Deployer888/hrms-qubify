    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Account List')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('accountlist.create') }}"
                                        ...
                                        <td class="text-right action-btns">
                                            @can('Edit Account List')
                                                <a href="#"
                                                    ...
                                                    data-title="{{ __('Edit Account List') }}" class="edit-icon"
                                            ...
                                            @can('Delete Account List')
                                                <a href="#" class="delete-icon" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $accountlist->id }}').submit();"><i
                                                        class="fas fa-trash"></i></a>
                                                <form id="delete-form-{{ $accountlist->id }}"
                                                    action="{{ route('accountlist.destroy', $accountlist->id) }}"
                                                    method="POST">
                                                    @csrf
                                                </form>
                                            @endcan
