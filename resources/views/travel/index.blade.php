    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Travel')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('travel.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-ajax-popup="true" data-title="{{ __('Create New Trip') }}">
                                            ...
                                            <td class="text-right action-btns">
                                                @can('Edit Travel')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Trip') }}" class="edit-icon"
                                                        data-bs-toggle="tooltip" title="{{ __('Edit Trip') }}"><i
                                                ...
                                                @can('Delete Travel')
                                                    <a href="#" class="delete-icon" data-bs-toggle="tooltip"
                                                        ...
                                                        data-confirm-yes="document.getElementById('delete-form-{{ $travel->id }}').submit();"><i
