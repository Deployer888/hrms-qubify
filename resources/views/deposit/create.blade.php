        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select name="account_id" id="account_id" class="form-control select2" placeholder="{{ __('Choose Account') }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="amount" id="amount" class="form-control" placeholder="{{ __('Amount') }}" step="0.01" value="{{ old('amount') }}">
                </div>
            </div>
            <!-- Date input -->
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="date" id="date" class="form-control datepicker" value="{{ old('date') }}">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="income_category_id" id="income_category_id" class="form-control select2" placeholder="{{ __('Choose A Category') }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="payment_type_id" id="payment_type_id" class="form-control select2" placeholder="{{ __('Choose Payment Method') }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="referal_id" id="referal_id" class="form-control" value="{{ old('referal_id') }}">
                </div>
            </div>
            <!-- Description input -->
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="{{ __('Description') }}">{{ old('description') }}</textarea>
                </div>
            </div>
