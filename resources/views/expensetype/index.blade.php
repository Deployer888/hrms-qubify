    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Expense Type')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('expensetype.create') }}"
                                        ...
                                        <td>
                                            @can('Edit Expense Type')
                                                <a href="#"
                                                    ...
                                                    data-title="{{ __('Edit Expense Type') }}" class="edit-icon"
                                            ...
                                            @can('Delete Expense Type')
                                                <a href="#" class="delete-icon" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $expensetype->id }}').submit();"><i
