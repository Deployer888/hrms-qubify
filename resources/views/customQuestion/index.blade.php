                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($question->is_required == 'yes')
                                                <span
                                                    class="badge badge-soft-success">{{ \App\models\CustomQuestion::$is_required[$question->is_required] }}</span>
                                            @else
                                                <span
                                                    class="badge badge-soft-danger">{{ \App\models\CustomQuestion::$is_required[$question->is_required] }}</span>
                                            @endif
                                        </td>
                                        <td>
                                            @can('Edit Custom Question')
                                                <a href="#" data-url="{{ route('custom-question.edit', $question->id) }}"
                                                    ...
                                                    data-title="{{ __('Edit Custom Question') }}" class="edit-icon"
