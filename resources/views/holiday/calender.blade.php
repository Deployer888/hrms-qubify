            ...
            <form action="{{ route('holiday.calender') }}" method="get" id="holiday_filter">
                <div class="all-select-box">
                    <div class="btn-box">
                        ...
                        <input type="text" name="start_date" id="start_date" class="month-btn form-control datepicker"
        ...
        <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
            <div class="all-select-box">
                <div class="btn-box">
                    ...
                    <input type="text" name="end_date" id="end_date" class="month-btn form-control datepicker"
                        value="{{ isset($_GET['end_date']) ? $_GET['end_date'] : '' }}">
                </div>
            </div>
        </div>
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn" onclick="document.getElementById('holiday_filter').submit(); return false;"
                data-toggle="tooltip" data-original-title="{{ __('apply') }}">
                <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
            </a>
            <a href="{{ route('holiday.calender') }}" class="reset-btn" data-toggle="tooltip"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button"
                                class="btn btn-sm btn-primary rounded-pill float-right new-event--add">Create
                                event</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="edit-event" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-sm btn-link" data-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-sm btn-primary rounded-pill float-right"
