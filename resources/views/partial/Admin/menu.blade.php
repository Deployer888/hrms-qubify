            ...
            <ul class="navbar-nav navbar-nav-docs">
                ...
                @if(Gate::check('Manage Employee'))
                    @if(\Auth::user()->type == 'employee')
                        ...
                        {{-- <!--<li class="nav-item ">
                            <a href="{{route('attendanceemployee.aadhaar.get')}}" class="nav-link {{ request()->is('attendanceemployee*') ? 'active' : '' }}">
                                <i class="fas fa-users"></i>{{ __('Mark Attendance') }}
                            </a>
                        </li>--> --}}
                        @if($employee->is_team_leader == 1)

                        <li class="nav-item">
                            <a class="nav-link my-team {{ (Request::route()->getName() == 'employee.member.show' || request()->is('get-my-team*') || request()->is('member-leaves*') ? 'active' : 'collapsed') }}"
                               href="#navbar-my-team" data-toggle="collapse" role="button" aria-expanded="{{ (request()->is('get-my-team*') || request()->is('team/employee*') || request()->is('member-leaves*')) ? 'true' : 'false' }}" aria-controls="navbar-my-team">
                                <i class="fas fa-users "></i>{{ __('My Team') }}
                                <i class="fas fa-sort-up"></i>
                            </a>
                            <div class="collapse my-team {{ (request()->is('get-my-team*') ||request()->is('team/employee*') || request()->is('member-leaves*')) ? 'show' : '' }}"
                                 id="navbar-my-team">
                                <ul class="nav flex-column submenu-ul">
                        
                                    <li class="nav-item {{ request()->is('team/employee*') || request()->is('get-my-team*') ? 'active' : '' }}">
                                        <a href="{{ route('employee.team-members') }}" class="nav-link">{{ __('Team Members') }}</a>
                                    </li>
                                    <li class="nav-item {{ request()->is('member-leaves*') ? 'active' : '' }}">
                                        <a href="{{ route('employee.member-leaves') }}" class="nav-link">{{ __('Member Leaves') }}</a>
                                    </li> 
                        ...
                        <li class="nav-item {{ request()->is('training*') ? 'active' : '' }}">
                            <a href="{{ route('training.index') }}" class="nav-link"><i class="fas fa-graduation-cap"></i>{{ __('Training List') }}</a>
                        </li>
                        @endif
                    @else
                        <li class="nav-item">
                            ...
                            <div class="collapse my-team {{ (Request::route()->getName() == 'employee.exit-employee') || (Request::route()->getName() == 'employee.index') ||  (Request::route()->getName() == 'employee.create') ||  (Request::route()->getName() == 'employee.edit') ||  (Request::route()->getName() == 'employee.show') ? 'show' : '' }}"
                                ...
                                <ul class="nav flex-column submenu-ul">
                                    ...
                                    <li class="nav-item {{ (Request::route()->getName() == 'employee.exit-employee') ? 'active' : '' }}">
                                        <a href="{{ route('employee.exit-employee') }}" class="nav-link">{{ __('Exit Employee') }}</a>
                                    </li> 
                        ...
                        <li class="nav-item ">
                            <a href="{{route('aadhaar.index')}}" class="nav-link {{ request()->is('aadhar*') ? 'active' : '' }}">
                                <i class="fas fa-users"></i>{{ __('Aadhar Verification') }}
                            </a>
                        </li>
                    @endif
                @endif
                ...
                @if( Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet'))
                    ...
                    @can('Manage Leave')
                        <li class="nav-item">
                            <a href="{{ route('leave.index') }}" class="nav-link {{ request()->is('leave*') ? 'active' : '' }}"><i class="fas fa-envelope-open-text"></i>{{ __('Leave') }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('attendanceemployee.index') }}" class="nav-link {{ (Request::route()->getName() == 'attendanceemployee.index') ? 'active' : '' }}"><i class="fas fa-flag-checkered"></i>{{__('Attendance')}}</a>
                        </li>
                    @endcan
                            ...
                            <ul class="nav flex-column submenu-ul">
                                @can('Manage Office')
                                    <li class="nav-item {{ request()->is('office*') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('office.index') }}">{{ __('Office') }}</a>
                                    </li>
                                @endcan
                                @can('Manage Branch')
