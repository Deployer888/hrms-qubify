    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Document Type')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('document.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-ajax-popup="true" data-title="{{ __('Create New  Document Type') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="float-left mr-1">
                                                ...
                                                @else
                                                    <div class="badge rounded-pill badge-danger">{{ __('Not Required') }}
                                                    </div>
                                                @endif
                                            </h6>
                                        </td>
                                            ...
                                            <td class="text-right action-btns">
                                                @can('Edit Document Type')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Document Type') }}" class="edit-icon"
