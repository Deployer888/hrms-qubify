                                            ...
                                            <span>
                                                @can('Edit Performance Type')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Performance Type') }}" class="edit-icon"
                                                ...
                                                @can('Delete Performance Type')
                                                    <a href="#" class="delete-icon" data-toggle="tooltip"
                                                        ...
                                                        data-confirm-yes="document.getElementById('delete-form-{{ $performance_type->id }}').submit();"><i
                                                            class="fas fa-trash"></i></a>
                                                    <form method="POST"
                                                        action="{{ route('performanceType.destroy', $performance_type->id) }}"
