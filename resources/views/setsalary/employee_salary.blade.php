                                ...
                                @can('Create Set Salary')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('employee.basic.salary', $employee->id) }}"
                                            data-size="md" data-ajax-popup="true" data-title="{{ __('Set Basic Salary') }}"
                                            data-bs-toggle="tooltip" title="{{ __('Basic Salary') }}"
                                            class="apply-btn">
                                ...
                                <div class="project-info-inner mr-3 col-6">
                                    ...
                                    <div class="project-amnt pt-1" >
                                        <div id="salary-display" style="display: flex; align-items: center;">
                                            <span id="hidden-salary">*****</span>
                                            <span id="actual-salary" style="display: none;">₹ {{$employee->salary}}</span>
                                ...
                                @can('Create Allowance')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('allowances.create', $employee->id) }}"
                                            ...
                                            data-bs-toggle="tooltip" title="{{ __('Create Allowance') }}"
                                            class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                            ...
                                            <td>
                                                @can('Edit Allowance')
                                                    <a href="#"
                                                        ...
                                                        data-bs-toggle="tooltip" title="{{ __('Edit') }}"><i
                                                ...
                                                @can('Delete Allowance')
                                                    ...
                                                    <form action="{{ route('allowance.destroy', $allowance->id) }}"
                                                        method="post" id="allowance-delete-form-{{ $allowance->id }}">
                                                        @method('DELETE')
                                                        @csrf
                                                    </form>
                                                @endcan
                                ...
                                @can('Create Commission')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('commissions.create', $employee->id) }}"
                                            data-size="md" data-ajax-popup="true" title="{{ __('Create Commission') }}"
                                            data-bs-toggle="tooltip" class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                @endcan
                                            ...
                                            <td class="text-right">
                                                @can('Edit Commission')
                                                    <a href="#"
                                                        ...
                                                        data-size="lg" data-ajax-popup="true"
                                                        title="{{ __('Edit Commission') }}" class="edit-icon"
                                                ...
                                                @can('Delete Commission')
                                                    ...
                                                    <form action="{{ route('commission.destroy', $commission->id) }}"
                                                        method="post" id="commission-delete-form-{{ $commission->id }}">
                                                        @method('DELETE')
                                                        @csrf
                                                    </form>
                                                @endcan
                                ...
                                @can('Create Loan')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('loans.create', $employee->id) }}"
                                            data-size="md" data-ajax-popup="true" title="{{ __('Create Loan') }}"
                                            data-bs-toggle="tooltip" class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                            ...
                                            <td class="text-right">
                                                @can('Edit Loan')
                                                    <a href="#" data-url="{{ URL::to('loan/' . $loan->id . '/edit') }}"
                                                        data-size="lg" data-ajax-popup="true"
                                                        title="{{ __('Edit Loan') }}" class="edit-icon"
                                                        data-bs-toggle="tooltip"><i
                                                            class="fas fa-pencil-alt"></i></a>
                                                @endcan
                                                @can('Delete Loan')
                                ...
                                @can('Create Saturation Deduction')
                                    <div class="col text-right">
                                        <a href="#"
                                            ...
                                            title="{{ __('Create Saturation Deduction') }}" data-bs-toggle="tooltip" class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                @endcan
                                            ...
                                            <td class="text-right">
                                                @can('Edit Saturation Deduction')
                                                    <a href="#"
                                                        ...
                                                        data-size="lg" data-ajax-popup="true"
                                                        data-title="{{ __('Edit Saturation Deduction') }}" class="edit-icon"
                                ...
                                @can('Create Other Payment')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('otherpayments.create', $employee->id) }}"
                                            data-size="md" data-ajax-popup="true" title="{{ __('Create Other Payment') }}"
                                            data-bs-toggle="tooltip" class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                            ...
                                            <td class="text-right">
                                                ...
                                                @can('Delete Other Payment')
                                                    ...
                                                    <form action="{{ route('otherpayment.destroy', $otherpayment->id) }}"
                                                        method="post" id="payment-delete-form-{{ $otherpayment->id }}">
                                                        @method('DELETE')
                                                        @csrf
                                                    </form>
                                                @endcan
                                ...
                                @can('Create Overtime')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('overtimes.create', $employee->id) }}"
                                            data-size="md" data-ajax-popup="true" title="{{ __('Create Overtime') }}"
                                            data-bs-toggle="tooltip" class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                            ...
                                            <td class="text-right">
                                                ...
                                                @can('Delete Overtime')
                                                    ...
                                                    <form action="{{ route('overtime.destroy', $overtime->id) }}"
                                                        method="post" id="overtime-delete-form-{{ $overtime->id }}">
                                                        @method('DELETE')
                                                        @csrf
                                                    </form>
                                                @endcan
