    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Payment Type')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('paymenttype.create') }}"
                    class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true"
                    data-title="{{ __('Create New Payment Type') }}">
                                        ...
                                        <td>
                                            @can('Edit Payment Type')
                                                <a href="#"
                                                    ...
                                                    data-title="{{ __('Edit Payment Type') }}" class="edit-icon"
                                            ...
                                            @can('Delete Payment Type')
                                                <a href="#" class="delete-icon" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $paymenttype->id }}').submit();"><i
                                                        class="fas fa-trash"></i></a>
                                                <form action="{{ route('paymenttype.destroy', $paymenttype->id) }}"
                                                    method="POST" id="delete-form-{{ $paymenttype->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                    @endif
