    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Job')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="{{ route('job.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($job->status == 'active')
                                                <span
                                                    class="badge badge-success">{{ App\Models\Job::$status[$job->status] }}</span>
                                            @else
                                                <span
                                                    class="badge badge-danger">{{ App\Models\Job::$status[$job->status] }}</span>
                                            @endif
                                        </td>
