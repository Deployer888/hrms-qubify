                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="branch" id="branch" class="form-control select2" required>
                                    @foreach ($branches as $value => $label)
                                        <option value="{{ $value }}" {{ $job->branch == $value ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select name="category" id="category" class="form-control select2" required>
                                    @foreach ($categories as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ $job->category == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" id="status" class="form-control select2" required>
                                    @foreach ($status as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ $job->status == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="my-4">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="check-gender">{{ __('Gender') }}
                                            </label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="applicant[]"
