        ...
        <div class="col-auto">
            <form action="{{ route('job-application.index') }}" method="get" id="application_filter">
                <div class="form-group">
                    ...
                    <input type="text" name="start_date" id="start_date" value="{{ $filter['start_date'] }}"
                        class="month-btn form-control datepicker">
                </div>
                <div class="form-group">
                    <label for="end_date" class="text-type">{{ __('End Date') }}</label>
                    <input type="text" name="end_date" id="end_date" value="{{ $filter['end_date'] }}"
                        class="month-btn form-control datepicker">
                </div>
                <div class="form-group">
                    <label for="job" class="text-type">{{ __('Job') }}</label>
                    <select name="job" id="job" class="form-control select2">
                        @foreach ($jobs as $job_id => $job_name)
                            <option value="{{ $job_id }}" @if ($job_id == $filter['job']) selected @endif>
                                {{ $job_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-auto my-custom">
                    <a href="#" class="apply-btn"
                        onclick="document.getElementById('application_filter').submit(); return false;"
                        data-toggle="tooltip" data-original-title="{{ __('apply') }}">
                        <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
                    </a>
                    <a href="{{ route('job-application.index') }}" class="reset-btn" data-toggle="tooltip"
                        data-original-title="{{ __('Reset') }}">
                        <span class="btn-inner--icon"><i class="fas fa-trash-restore-alt"></i></span>
                    </a>
                    @can('Create Job Application')
                        <a href="#" data-url="{{ route('job-application.create') }}" data-ajax-popup="true"
