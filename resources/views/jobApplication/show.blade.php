    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-fluid">
                                ...
                                @can('Delete Job Application')
                                    ...
                                    @if ($jobApplication->is_archive == 0)
                                        <li class="list-inline-item">
                                            <a href="#"
                                                data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?"
                                                data-confirm-yes="document.getElementById('delete-form-{{ $jobApplication->id }}').submit();"><span
                                                    class="badge badge-pill badge-soft-danger">{{ __('Delete') }}</span></a>
                                            <form method="POST"
                ...
                <div class="card-body">
                    <h5 class="h4">
                        <div class="d-flex align-items-center" data-bs-toggle="tooltip" data-placement="right"
                            data-title="2 hrs ago" title="" title="">
                            <div>
                    ...
                    <div class="py-2 my-4 border-top ">
                            ...
                            @foreach ($stages as $stage)
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="stage_{{ $stage->id }}" name="stage"
                                        ...
                                        class="custom-control-input stages"
                        ...
                        <div class="col-12 text-right">
                            <a href="#" data-url="{{ route('job.on.board.create', $jobApplication->id) }}"
                                data-ajax-popup="true" class="btn btn-xs btn-white btn-icon-only width-auto">
                                {{ __('Add to Job OnBoard') }}</a>
                        </div>
                    </div>
                    ...
                    <div class='rating-stars text-right'>
                        <ul id='stars'>
                            <li class='star {{ in_array($jobApplication->rating, [1, 2, 3, 4, 5]) == true ? 'selected' : '' }}'
                                data-bs-toggle="tooltip" data-title="Poor" data-value='1'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [2, 3, 4, 5]) == true ? 'selected' : '' }}'
                                data-bs-toggle="tooltip" data-title='Fair' data-value='2'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [3, 4, 5]) == true ? 'selected' : '' }}'
                                data-bs-toggle="tooltip" data-title='Good' data-value='3'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [4, 5]) == true ? 'selected' : '' }}'
                                data-bs-toggle="tooltip" data-title='Excellent' data-value='4'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{ in_array($jobApplication->rating, [5]) == true ? 'selected' : '' }}'
                                data-bs-toggle="tooltip" data-title='WOW!!!' data-value='5'>
                                <i class='fa fa-star fa-fw'></i>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    @can('Delete Job Application Note')
                                        @if ($note->note_created == \Auth::user()->id)
                                            <div class="col-auto text-right">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('job.application.note.destroy', $note->id) }}"
