    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Announcement')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('announcement.create') }}"
                            ...
                            <tbody class="font-style">
                                @foreach ($announcements as $announcement)
                                    <tr>
                                        ...
                                        <td style="max-width: 200px; white-space: normal;">{{ substr($announcement->description, 0, 100) . (strlen($announcement->description) > 100 ? '...' : ''), }}</td>
                                        @if (Gate::check('Edit Announcement') || Gate::check('Delete Announcement'))
                                            <td class="text-right action-btns">
                                                @can('Edit Announcement')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Announcement') }}" class="edit-icon"
                                                ...
                                                @can('Delete Announcement')
                                                    <a href="#" class="delete-icon" data-toggle="tooltip"
                                                        ...
                                                        data-confirm-yes="document.getElementById('delete-form-{{ $announcement->id }}').submit();"><i
