            ...
            <div class="card">
                <div class="card-body py-0">
                    <div class="row d-flex justify-content-start mt-2">
                                        ...
                                        <div class="choose-file form-group">
                                            <label for="clock_in" class="form-control-label">
                                                ...
                                                <input type="file" class="form-control" name="clock_in_file" id="clock_in"
                                                    data-filename="clock_in_file" required>
                                            </label>
                                        ...
                                        <div class="choose-file form-group">
                                            <label for="file" class="form-control-label">
                                                ...
                                                <input type="file" class="form-control" name="clock_out_file" id="file"
                                                    data-filename="clock_out_file" required>
                                            </label>
                        ...
                        <?php
                            $batchList = Helper::attendanceBatchList();
                            // dd($batchList);
                        ?>
                                        ...
                                        <select name="batch_id" class="form-control select2">
                                            ...
                                            @if($batchList->count() > 0) {
                                                @foreach (Helper::attendanceBatchList() as $batch_id)
                                                    @php
                                                        $date = \Carbon\Carbon::createFromTimestamp($batch_id, 'Asia/Kolkata');
                                                    @endphp
                                ...
                                @if(\Auth::user()->type == 'employee')
                                    ...
                                    @else
                                        ...
                                        @elseif(!$attEmp['is_weekend'] && !$attEmp['is_leave'])
                                            <tr>
                                                <td align="center" colspan="7" data-toggle="collapse" data-target="#collapse-{{ $key }}" role="button"  style="background-color: #004041; /* Light gray */
                                                color: #fff;">{{ $key }}</td>
                                            </tr>
                                                    ...
                                                    <div style="display: flex; align-items: center; justify-content: center; width: 100%; position: relative;">
                                                        <span>
                                                            ...
                                                            @if($leaveToday && $leaveToday != 0)
                                                                <span class="bg-warning" style="color: #FFF !important; padding: 5px; border-radius: 10px; background-color:#ffac04 !important;">
                                                                    {{ $leaveToday }}
                                                                </span>
                                                            @endif
                                                        </span>
