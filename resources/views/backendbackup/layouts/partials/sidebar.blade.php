            ...
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        {{-- @if ($usr->can('industry.view')) --}}
                                <li class="{{ Route::is('admin.industries.index')  || Route::is('admin.industries.edit') ? 'active' : '' }}"><a href="{{ route('admin.industries.index') }}">All Industries</a></li>
                            {{-- @endif --}}
                            {{-- @if ($usr->can('industry.create')) --}}
                                <li class="{{ Route::is('admin.industries.create')  ? 'active' : '' }}"><a href="{{ route('admin.industries.create') }}">Create Industry</a></li>
                            {{-- @endif --}}
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-tasks"></i><span>
                                    Industry List
                    ...
                    <li>
                        ...
                        <ul class="collapse {{ Route::is('admin.services.create') || Route::is('admin.services.index') || Route::is('admin.services.edit') || Route::is('admin.services.show') ? 'in' : '' }}">
                            ...
                            {{-- @if ($usr->can('service.create')) --}}
                                <li class="{{ Route::is('admin.services.create')  ? 'active' : '' }}"><a href="{{ route('admin.services.create') }}">Create Service</a></li>
                            {{-- @endif --}}
                        </ul>
                    </li>
                    {{-- @endif --}}
                    ...
                    <li>
                        ...
                        <ul class="collapse {{ Route::is('admin.technologies.create') || Route::is('admin.technologies.index') || Route::is('admin.technologies.edit') || Route::is('admin.technologies.show') ? 'in' : '' }}">
                            {{-- @if ($usr->can('technology.view')) --}}
                                <li class="{{ Route::is('admin.technologies.index')  || Route::is('admin.technologies.edit') ? 'active' : '' }}"><a href="{{ route('admin.technologies.index') }}">All Technologies</a></li>
                            {{-- @endif --}}
                            {{-- @if ($usr->can('technology.create')) --}}
                                <li class="{{ Route::is('admin.technologies.create')  ? 'active' : '' }}"><a href="{{ route('admin.technologies.create') }}">Create Technology</a></li>
                            {{-- @endif --}}
                        </ul>
                    </li>
                    {{-- @endif --}}
