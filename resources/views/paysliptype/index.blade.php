    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Payslip Type')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('paysliptype.create') }}"
                    class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true"
                    data-title="{{ __('Create Payslip Type') }}">
                                        ...
                                        <td>
                                            @can('Edit Payslip Type')
                                                <a href="#"
                                                    ...
                                                    data-title="{{ __('Edit Payslip Type') }}" class="edit-icon"
                                            ...
                                            @can('Delete Payslip Type')
                                                <a href="#" class="delete-icon" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $paysliptype->id }}').submit();"><i
