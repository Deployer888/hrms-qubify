    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Deduction Option')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('deductionoption.create') }}"
                                        ...
                                        <td>
                                            @can('Edit Deduction Option')
                                                <a href="#"
                                                    ...
                                                    data-title="{{ __('Edit Deduction Option') }}" class="edit-icon"
                                            ...
                                            @can('Delete Deduction Option')
                                                <a href="#" class="delete-icon" data-toggle="tooltip"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-{{ $deductionoption->id }}').submit();"><i
