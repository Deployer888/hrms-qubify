...
@section('content')
    ...
    <input type="hidden" id="att_id" value="{{ isset($employeeAttendance) && $employeeAttendance ? $employeeAttendance->id : '' }}" />
    <input type="hidden" id="employee_id" value="{{ \Auth::user()->employee ? \Auth::user()->employee->id : '' }}" />
                        ...
                        <div class="clock-forms">
                            <form id="clock_in_form">
                                ...
                                @php
                                    ...
                                    $alwaysAllowed = [];
                                    $disabledIn = 'disabled';
                                    if (empty($employeeAttendance) || ($employeeAttendance && $employeeAttendance->clock_out != '00:00:00'))
                                        $disabledIn = '';
                                @endphp
                                ...
                                @else
                                    <div class="alert alert-info">
                                        ...
                                        {{ __('Employee record not found. Please contact administrator to set up your employee profile.') }}
                                    </div>
                                @endif
                            </form>
