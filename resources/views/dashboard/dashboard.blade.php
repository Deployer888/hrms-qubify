                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <form id="clock_in_form">
                                ...
                                {{-- @if((\Auth::check() && \Auth::user()->employee && in_array($employeeId, [1, 4, 2, 5, 22])) && (now()->isWeekend() || now()->isWeekday() && (now()->format('H:i') < '10:00' || now()->format('H:i') > '18:00')) )<!-- && ( (weekday && time ) || (weekend))-->
                                ...
                                @if(\Auth::check() && \Auth::user()->employee)
                                    @if(in_array($employeeId, $alwaysAllowed) || 
                                       (in_array($employeeId, [1, 4, 2, 5, 22]) && (now()->isWeekend() || now()->isWeekday() && (now()->format('H:i') < '10:00' || now()->format('H:i') > '18:00'))))
