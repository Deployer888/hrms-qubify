...
@section('action-button')
    <div class="row d-flex justify-content-end">
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
            <form method="GET" action="{{ route('report.account.statement') }}" id="report_acc_filter">
        ...
        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="all-select-box">
                <div class="btn-box">
                    <label for="account" class="text-type">Account</label>
        ...
        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="all-select-box">
                <div class="btn-box">
                    <label for="type" class="text-type">Type</label>
        ...
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn"
                onclick="document.getElementById('report_acc_filter').submit(); return false;" data-toggle="tooltip"
                data-original-title="apply">
                <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
            </a>
            <a href="{{ route('report.account.statement') }}" class="reset-btn" data-toggle="tooltip"
                data-original-title="Reset">
                <span class="btn-inner--icon"><i class="fas fa-trash-restore-alt"></i></span>
            </a>
            <a href="#" class="action-btn" onclick="saveAsPDF()" data-toggle="tooltip" data-original-title="Download">
        ...
        <div class="row mt-3">
            ...
            <div class="col">
                <div class="card p-4 mb-4">
                    ...
                    <h5 class="report-text mb-0">{{ $filterYear['startDateRange'] . ' to ' . $filterYear['endDateRange'] }}
                    </h5>
                </div>
            </div>
        </div>
