...
@section('action-button')
    <div class="row d-flex justify-content-end">
        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12">
            <form action="{{ route('report.timesheet') }}" method="get" id="report_timesheet">
            ...
            <div class="all-select-box">
                <div class="btn-box">
                    ...
                    <input type="text" name="end_date"
                        value="{{ isset($_GET['end_date']) ? $_GET['end_date'] : date('Y-m-t') }}"
                        class="month-btn form-control datepicker">
                </div>
            </div>
        </div>
        ...
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn"
                onclick="document.getElementById('report_timesheet').submit(); return false;" data-toggle="tooltip"
                data-original-title="{{ __('apply') }}">
                <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
            </a>
            <a href="{{ route('report.timesheet') }}" class="reset-btn" data-toggle="tooltip"
