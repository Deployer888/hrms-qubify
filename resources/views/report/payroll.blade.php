...
@section('action-button')
    <div class="row d-flex justify-content-end">
        <div class="col-auto">
            <form action="{{ route('report.payroll') }}" method="get" id="report_payroll">
                <div class="all-select-box">
                    <div class="btn-box">
                        <label for="type" class="text-type">{{ __('Type') }}</label> <br>
                        <div class="d-flex radio-check">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="monthly" name="type" value="monthly"
                                    class="custom-control-input monthly"
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="yearly" name="type" value="yearly"
                                    class="custom-control-input yearly"
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 year d-none">
            <div class="all-select-box">
                <div class="btn-box">
                    <label for="year" class="text-type">{{ __('Year') }}</label>
        ...
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn" onclick="document.getElementById('report_payroll').submit(); return false;"
                data-toggle="tooltip" data-original-title="{{ __('apply') }}">
                <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
            </a>
            <a href="{{ route('report.payroll') }}" class="reset-btn" data-toggle="tooltip"
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                <div class="card p-4 mb-4">
                    ...
                    <h5 class="report-text mb-0">{{ \Auth::user()->priceFormat($filterData['totalSaturationDeduction']) }}
                    </h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
