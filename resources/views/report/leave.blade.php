...
<div class="row d-flex justify-content-end">
    ...
    <div class="col-xl-3 col-lg-3 month">
        <div class="all-select-box">
            <div class="btn-box">
                <label class="text-type">{{ __('Month') }}</label>
    ...
    <div class="col-xl-3 col-lg-3 year d-none">
        <div class="all-select-box">
            <div class="btn-box">
                <label class="text-type">{{ __('Year') }}</label>
                <select class="form-control select2" id="year" name="year">
                    @for ($filterYear['starting_year']; $filterYear['starting_year'] <= $filterYear['ending_year']; $filterYear['starting_year']++)
                        <option value="{{ $filterYear['starting_year'] }}"
                            {{ (isset($_GET['year']) && $_GET['year'] == $filterYear['starting_year']) || (!isset($_GET['year']) && date('Y') == $filterYear['starting_year']) ? 'selected' : '' }}>
    ...
    <div class="col-xl-2 col-lg-3">
        <div class="all-select-box">
            <div class="btn-box">
                <label class="text-type">{{ __('Branch') }}</label>
    ...
    <div class="col-xl-2 col-lg-3">
        <div class="all-select-box">
            <div class="btn-box">
                <label class="text-type">{{ __('Department') }}</label>
