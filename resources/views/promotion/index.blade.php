    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Promotion')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('promotion.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-ajax-popup="true" data-title="{{ __('Create New Promotion') }}">
                                            ...
                                            <td class="text-right action-btns">
                                                @can('Edit Promotion')
                                                    <a href="#"
                                                        ...
                                                        data-title="{{ __('Edit Promotion') }}" class="edit-icon"
                                                ...
                                                @can('Delete Promotion')
                                                    <a href="#" class="delete-icon" data-toggle="tooltip"
                                                        ...
                                                        data-confirm-yes="document.getElementById('delete-form-{{ $promotion->id }}').submit();"><i
