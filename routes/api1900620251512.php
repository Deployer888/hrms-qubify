...
use App\Http\Controllers\Api\{KioskAdminController, AppVersionController, OfficeController};
...
Route::group(['middleware' => ['auth:api']],function(){
    ...
    // Attendance 
    Route::get('attendance', [AttController::class, 'getEmployeeList']);
    ...
    Route::get('/office-details/{id}', [OfficeController::class, 'details']);
