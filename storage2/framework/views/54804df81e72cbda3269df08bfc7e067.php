...
<!-- modernizr css -->
<script src="<?php echo e(asset('backend/assets/js/vendor/modernizr-2.8.3.min.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\hrms-qubify\resources\views/backend/layouts/partials/styles.blade.php ENDPATH**/ ?>