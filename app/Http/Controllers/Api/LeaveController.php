            ...
            if(Auth::user()->type == 'employee')
            {
                ...
                foreach ($allLeaveTypes as $leaveType) {
                    ...
                    if ($leaveType->title == 'Paid Leave') {
                        ...
                        // Use Helper for other leave types including pending leaves
                        $leavesAvailed = \App\Helpers\Helper::totalLeaveAvailed($employee->id, $employee->company_doj, $formattedDate, $leaveType->id);
