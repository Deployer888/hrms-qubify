...
class EmployeeController extends Controller
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             required={"name", "dob", "gender", "phone", "address", "email", "password", "department_id", "designation_id", "shift_start"},
     *             @OA\Property(property="name", type="string", example="John Doe"),
     ...
     *             @OA\Property(property="shift_start", type="string", example="09:00"),
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="string", example="Employee successfully created.")
     *         )
     *     ),
     *     @OA\Response(
     *         response=400,
     ...
     *                 @OA\Property(property="dob", type="array", @OA\Items(type="string")),
     ...
     *                 @OA\Property(property="designation_id", type="array", @OA\Items(type="string")),
     *                 @OA\Property(property="shift_start", type="array", @OA\Items(type="string")),
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             required={"name", "dob", "gender", "phone", "address", "shift_start"},
     *             @OA\Property(property="name", type="string", example="John Doe"),
     *             @OA\Property(property="dob", type="string", format="date", example="1990-01-01"),
     *             @OA\Property(property="gender", type="string", example="Male"),
     *             @OA\Property(property="phone", type="string", example="1234567890"),
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="string", example="Employee successfully updated.")
     *         )
     *     ),
     *     @OA\Response(
     *         response=400,
