...
class Utility extends Model
{
    public static function settings()
    {
        ...
        $shift_start = '';
        if(isset($employee))
            $shift_start = date('H:i', strtotime($employee->shift_start));
        ...
        $settings = [
            ...
            "footer_title" => "",
            "footer_notes" => "",
            "company_start_time" => $shift_start,
            "company_end_time" => "22:00",
            'user_create' => '1',
            'employee_create' => '1',
            'payroll_create' => '1',
            'ticket_create' => '1',
        ...
        foreach ($data as $row) {
            if ($row->name == 'company_start_time') {
                $row->value = $shift_start;        
            }
